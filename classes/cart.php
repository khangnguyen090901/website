...
<?php
    class cart
    {
        ...
        public function add_to_cart($quantity,$id){
            ...
            $query_cart =  $this->db->select($query_cart); 
            if($query_cart){
        ...
        public function update_quantity_cart($quantity,$cartId){
            ...
            if($result){
                ...
                $msg = "<span style='color:red;'>An Error Has Been Corrupted</span>";
                return $msg;
            }
        ...
        public function shifted($id,$time,$price){
            ...
            $result = $this->db->update($query);
            if($result){
                $msg = "<span style='color:green;'>Order Has Been Updated</span>";
                return $msg;
            }
            else{
                $msg = "<span style='color:red;'>An Error Has Been Corrupted</span>";
        ...
        public function del_shifted($id,$time,$price){
            ...
            $result = $this->db->update($query);
            if($result){
                $msg = "<span style='color:green;'>Order Has Been Deleted</span>";
                return $msg;
            }
            else{
                $msg = "<span style='color:red;'>An Error Has Been Corrupted</span>";
