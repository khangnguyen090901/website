    ...
    class category
    {
        ...
        public function insert_category($catName)
        {
            ...
            if(empty($catName))
            {
                ...
                if($result)
                {
                    $alert = "<span class='success'>New Categpry Has Been Added</span>";
                    return $alert;
                }
                else
                {
        ...
        public function update_category($catName,$id)
        {
            ...
            if(empty($catName))
            {
                ...
                if($result)
                {
                    $alert = "<span class='success'>Category has been Updated</span>";
                    return $alert;
                }
                else
                {
        ...
        public function del_category($id)
        {
            ...
            if($result)
            {
                $alert = "<span class='success'>Category Has Been Deleted</span>";
                return $alert;
            }
            else
            {
