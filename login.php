 ...
 <div class="main">
    <div class="content" style='text-align:center;'>
    	 <div class="login_panel">
        	...
        	<form action="" method="POST">
                 ...
                 <p class="note">If you forgot your passoword just enter your email and click <a href="#">here</a></p>
                    <div class="buttons"><div><input type="submit" name="login" class="grey" value = "Sign In" style='font-size:18px;background:#fff;'></div></div>
					</form>
         </div>
    	<div class="register_account">
		   ...
		   <div class="search"><div><input type="submit" name="submit" class="grey" value = "Create Account" style='font-size:18px;background:#fff;'></div></div>
